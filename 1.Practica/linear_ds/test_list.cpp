    ...
    while (input) {
      ...
      if (input) {
        ...
        if (operation == "CREATE_NODE") {
          ...
          int idx1, idx2;
          input >> idx1 >> idx2;
          std::cout << "Linking node " << idx2 << " as next of node " << idx1
                    << " ... ";
          ...
          int idx1, idx2;
          input >> idx1 >> idx2;
          std::cout << "Linking node " << idx2 << " as prev of node " << idx1
                    << " ... ";
          ...
          std::cout << "Setting node " << idx << " item to: " << value
                    << std::endl;
        }
        ...
        // TEST LIST ITERATOR **************************************
          ...
          std::cout << ((iterator == l->end()) ? "Y" : "N") << std::endl;
        ...
        //  TEST INSERT/REMOVE  *************************************
          ...
          std::cout << "Removing " << iterator.item() << " from list ... "
                    << std::endl;
          l->remove(iterator);
          std::cout << "ok." << std::endl;
          ...
          std::cout << "Removing " << l->back() << " from the end ... ";
          l->pop_back();
          std::cout << "ok." << std::endl;
        }
        // TEST FOLD/UNFOLD **************************************
          ...
          l2->fold(std::cout);
          std::cout << " range [" << first.item() << ',' << last.item()
          ...
          auto i = l2->begin();
          i.goto_next(pos);
          std::cout << "Splice the list " << line << " position " << i.item()
                    << " at current list position ";
          if (iterator == l->end())
            std::cout << "end ... ";
          else
          ...
          std::cerr << "Error: operation not found '" << operation << "'."
                    << std::endl;
          return EXIT_FAILURE;
        }
      }
