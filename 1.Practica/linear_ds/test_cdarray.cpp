    ...
    while (input) {
      ...
      if (input) {
        if (operation == "CREATE") {
          ...
          int value;
          input >> pos >> value;
          std::cout << "Inserting at pos " << pos << " the value " << value
                    << " ... ";
          ...
          std::cout << "Is array empty()? " << (array->is_empty() ? "Y" : "N")
                    << std::endl;
        } else if (operation == "IS_FULL") {
          std::cout << "Is array full()? " << (array->is_full() ? "Y" : "N")
                    << std::endl;
        } else if (operation == "FRONT") {
          std::cout << "Front value is " << array->get(0) << std::endl;
        } else if (operation == "BACK") {
          std::cout << "Back value is " << array->get(array->size() - 1)
                    << std::endl;
        } else if (operation == "SET") {
          size_t pos;
          int value;
          input >> pos >> value;
          std::cout << "Setting at pos " << pos << " the value " << value
                    << " ... ";
          array->set(pos, value);
          std::cout << "ok." << std::endl;
          ...
          try {
            std::cout << "Unfolding the string '" << line << "' ... ";
