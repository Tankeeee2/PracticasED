...
int main(int argc, const char *argv[]) {
  ...
  try {
    ...
    while (std::getline(input_file, line)) {
      ...
      if (command == "IS_EMPTY") {
        std::cout << "Is it empty? " << (tree->is_empty() ? "Y." : "N.")
                  << std::endl;
        ...
        std::cout << "Balance factor = " << tree->balance_factor() << std::endl;
        ...
        *tree = create_perfectly_balanced_bstree<int>(data);
        ...
        std::cout << "Has a current item? "
                  << (tree->current_exists() ? "Y." : "N.") << std::endl;
      } else if (command == "CURRENT") {
        std::cout << "Current item: " << tree->current() << std::endl;
        ...
        std::cout << " min length = " << min << " max length = " << max
                  << std::endl;
